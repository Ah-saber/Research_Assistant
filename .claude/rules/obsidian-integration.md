...
| 技能 | 项目路径 | 说明 |
|------|----------|------|
| obsidian-markdown | `.claude/skills/obsidian-markdown/SKILL.md` | Markdown 格式参考技能 |
| json-canvas | `.claude/skills/json-canvas/SKILL.md` | Canvas 格式参考技能 |
| obsidian-bases | `.claude/skills/obsidian-bases/SKILL.md` | Bases 格式参考技能 |

**说明**：这些格式参考技能位于项目 `.claude/skills/` 目录，提供完整的格式规范文档。
...
- **格式参考技能**：`.claude/skills/obsidian-markdown/SKILL.md`, `.claude/skills/json-canvas/SKILL.md`, `.claude/skills/obsidian-bases/SKILL.md`
- **CLAUDE.md**：项目核心规则
- **docs/guides/**：使用指南
